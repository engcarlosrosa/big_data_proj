...
@WebServlet("/ServiceUpdateDadosPessoais")
public class ServiceUpdateDadosPessoais extends HttpServlet {
	...
	throws IOException, ServletException {
		...
		System.out.println("Estamos em rhcontroller/ServiceUpdateDadosPessoais.java");
		System.out.println(json);
		
		//POST
		HttpClient client = HttpClients.createDefault();
		String url = "http://localhost:8080/business_server_rhcontroller/RecebeUpdateJsonDadosPessoais";
		...
		List<NameValuePair>  urlParameters = new ArrayList<NameValuePair>();
 		...
 		out.println("<html>");
 		out.println("<body>");
 		out.println(dadosPessoais.getNome() + " atualizado com sucesso.");
